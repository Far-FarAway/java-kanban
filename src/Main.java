...
public class Main {
    public static void main(String[] args) {
        ...
        Subtask epic2Subtask1 = new Subtask("Найти мотивацию", "Чем больше, тем лучше", 360, "5.1.2025 12:00");
        Subtask epic2Subtask2 = new Subtask("Выйти погулять", "Это ножками делается", 3, "5.1.2025 18:00");
